...
// gcc -Wall -Wshadow -g main.c image-bmp.c answer07.c
// gcc -Wall -Wshadow -g main.c image-bmp.c answer07.c && valgrind --tool=memcheck --leak-check=full --verbose --log-file=memcheck.log ./a.out images/bmps/01-smile.bmp out.bmp && cat memcheck.log | tail -n 1
